...
export const password = Yup.string().required('Insira a senha').min(6, 'A senha deve ter entre 6 a 15 caracteres').max(15, 'A senha deve ter entre 6 a 15 caracteres');
